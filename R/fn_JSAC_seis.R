#A new version of RSEIS requires R version > 3.5.1. This is a very new version an not many people have it. Thus RSEIS has been moved from required to suggests and the function used in RSEIS has been copied to here
#' @export
